...
<div id="delete">
    ...
    <a class="back-link" href="<?php echo url_for('/public/admins/posts_delete.php'); ?>">&laquo; Back to List</a>
    ...
    <div>
        ...
        <form action="<?php echo url_for('/public/admins/delete_posts.php?id=' . h(u($id))); ?>" method="post">
            <div id="operations">
